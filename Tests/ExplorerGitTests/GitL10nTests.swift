...
final class GitL10nTests: XCTestCase {
    func testGitPanelStringsResolve() {
        ...
        XCTAssertNotEqual(L10n.Git.Panel.configureGit, "git.panel.configure_git")
        XCTAssertNotEqual(L10n.Git.Panel.configureGitHint, "git.panel.configure_git_hint")
        XCTAssertNotEqual(L10n.Git.Error.executableNotFound, "git.error.executable_not_found")
