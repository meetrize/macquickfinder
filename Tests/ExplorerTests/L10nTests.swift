...
final class ExplorerL10nTests: XCTestCase {
    ...
    func testExplorerLocalizedStringsResolve() {
        ...
        XCTAssertNotEqual(L10n.Toolbar.shortcutRemove, "toolbar.shortcut.remove")
        XCTAssertNotEqual(L10n.Toolbar.Error.shortcutMissingTitle, "toolbar.error.shortcut_missing_title")
        XCTAssertNotEqual(L10n.Toolbar.Error.shortcutMissing("Demo"), "toolbar.error.shortcut_missing")
        XCTAssertNotEqual(L10n.Preview.Toolbar.crop, "preview.toolbar.crop")
        XCTAssertNotEqual(L10n.Preview.Toolbar.applyCrop, "preview.toolbar.apply_crop")
        XCTAssertNotEqual(L10n.Preview.Save.overwriteConfirm("demo.png"), "preview.save.overwrite_confirm")
        ...
        XCTAssertNotEqual(L10n.Toolbar.hideLeftPanel, "toolbar.hide_left_panel")
        XCTAssertNotEqual(L10n.Toolbar.showRightPanel, "toolbar.show_right_panel")
        XCTAssertNotEqual(L10n.Toolbar.hideRightPanel, "toolbar.hide_right_panel")
        ...
        XCTAssertNotEqual(L10n.File.transferCopyProgress(2, 5), "file.transfer_copy_progress")
        XCTAssertNotEqual(L10n.File.transferCopyProgressWithName(2, 5, "demo.txt"), "file.transfer_copy_progress_with_name")
        XCTAssertNotEqual(L10n.File.transferMoveProgress(2, 5), "file.transfer_move_progress")
        XCTAssertNotEqual(L10n.File.transferMoveProgressWithName(2, 5, "demo.txt"), "file.transfer_move_progress_with_name")
        ...
        XCTAssertNotEqual(L10n.Snippets.Variable.ask, "snippets.variable.ask")
        XCTAssertNotEqual(L10n.Snippets.Variable.askNamed, "snippets.variable.ask_named")
        XCTAssertNotEqual(L10n.Snippets.Ask.formTitle, "snippets.ask.form_title")
        XCTAssertNotEqual(L10n.Snippets.Ask.continueButton, "snippets.ask.continue")
        XCTAssertNotEqual(L10n.Snippets.Ask.forSnippet("Demo"), "snippets.ask.for_snippet Demo")
        XCTAssertNotEqual(L10n.Error.SnippetAsk.emptyPrompt, "error.snippet_ask.empty_prompt")
        XCTAssertNotEqual(L10n.Error.SnippetAsk.unclosedBrace, "error.snippet_ask.unclosed_brace")
        XCTAssertNotEqual(L10n.Error.SnippetAsk.invalidId("x"), "error.snippet_ask.invalid_id x")
        ...
        XCTAssertNotEqual(L10n.Toolbar.closeTab, "toolbar.close_tab")
        XCTAssertNotEqual(L10n.Toolbar.closeOtherTabs, "toolbar.close_other_tabs")
        XCTAssertNotEqual(L10n.Toolbar.closeTabsToTheRight, "toolbar.close_tabs_to_the_right")
        XCTAssertNotEqual(L10n.Toolbar.moveTabToNewWindow, "toolbar.move_tab_to_new_window")
        ...
        XCTAssertNotEqual(L10n.Search.contentNoResults, "search.content_no_results")
        XCTAssertNotEqual(L10n.Search.findInFolder, "search.content_find_in_folder")
        XCTAssertNotEqual(L10n.Search.filterInclude, "search.filter.include")
        XCTAssertNotEqual(L10n.Help.entryName("content_search"), "help.entry.content_search.name")
